 <div>										<!-- action=... tells form which file to load on submit,  method="POST" hides everythig in URL -->
      <form id="create" class="formContainer" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>#create" method="POST">
  		<h2>Create User</h2>
  			<p>User would exist in school DB, so this is for demonstartion purposes</p>	
      	...
      	<div class="input-group">
      		<label for="pswd"></label>
      			...
      			<input class="form-control" type="password" id="pswd" name="pswd" placeholder="* Password" tabindex="4" required>
      			<br>
      	</div>
    	...
    	<br>
    	<br>
      		<input type="submit" value="Submit" name="submit" class="btn btn-default" style="margin:0 30px 0 30px;"> 
      		   
      		<a href="index.php" class="btn btn-default" role="button" style="margin:0 30px 0 30px;">Cancel</a>  
	        
	        <?php require('createU_submit.php')?>
